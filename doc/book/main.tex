...
As already stated, each statement is written through a series of
...
Commands are the instructions given to the machine. Our \enquote{Hello
  world} example featured two commands: one to push a value on the
stack, one to print the top value and remove it from the stack.
...
the number 5, which correspond to pushing the parameter on the stack.
