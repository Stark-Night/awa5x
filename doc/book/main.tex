...
calculate is \emph{count}: single bubbles always have a count of zero,
while double bubbles have a count higher than zero.
...
is not empty execution jump back to the beginning; otherwise, if the
top value is a single bubble the input is an empty line and the
