...
then we wait for input, finally the sequence of commands to convert
the temperature is the same as the first version of this program.

It is important to note that numbers are inserted as AWASCII
characters; therefore, only decimal digits are allowed:
\begin{verbatim}
~100
212
\end{verbatim}
...
\num{-17}, is not part of AWASCII; thus, to provide a negative number
